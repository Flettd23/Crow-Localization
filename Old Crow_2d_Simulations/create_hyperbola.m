function [points, slope] = create_hyperbola( a,b,phi_rad,X0,Y0,hyp_type, N)
%
% create_hyperbola - create a hyperbola (foci are based on the X axis) from the given 5 parameters
%
% Format:   points = create_hyperbola( a,b,phi_ra d,X0,Y0,hyp_type,N)
%
...
% the hyperbola
theta1_r        = linspace(-pi*0.62,pi*0.62,N/2);
...
otherwise,
    error( 'illegal value for variable "hyp_type", choose 1 for a horizontal hyperbolam or 2 for a vertical one' );
end
